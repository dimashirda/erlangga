			...
			<div class="col-md-6 col-md-offset-3">
				<div class="panel panel-login">
					...
					<div class="panel-body">
						<div class="row">
							<div class="col-lg-12">
								<form id="login-form" action="{{url('/login/auth')}}" method="post" role="form" style="display: block;">
									{{csrf_field()}}
							...
							<form id="register-form" action="{{url('/register')}}" method="post" role="form" style="display: none;">
								{{csrf_field()}}
									...
									<div class="form-group">
										<input type="password" name="masterpassword" id="password2" tabindex="2" class="form-control" placeholder="Master Password">										
									</div>
									<div class="form-group">
										<div class="row">
											<div class="col-sm-6 col-sm-offset-3">
